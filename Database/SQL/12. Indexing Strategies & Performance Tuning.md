...
- [12.1 Index Types](#121-index-types)
  - [12.1.1 B-Tree, Hash, Bitmap Indexes](#1211-b-tree-hash-bitmap-indexes)
  - [12.1.2 Full-Text and Spatial Indexes](#1212-full-text-and-spatial-indexes)
- [12.2 Composite & Covering Indexes](#122-composite-covering-indexes)
  - [12.2.1 Column Order and Selectivity](#1221-column-order-and-selectivity)
  - [12.2.2 Read vs Write Trade-Offs](#1222-read-vs-write-trade-offs)
- [12.3 Query Plan Analysis](#123-query-plan-analysis)
  - [12.3.1 EXPLAIN/EXPLAIN ANALYZE](#1231-explainexplain-analyze)
  - [12.3.2 Operator Costs & Bottlenecks](#1232-operator-costs-bottlenecks)
- [12.4 Clustered vs Nonclustered Indexes](#124-clustered-vs-nonclustered-indexes)
  - [12.4.1 Storage and Ordering Implications](#1241-storage-and-ordering-implications)
  - [12.4.2 Seek vs Scan Behaviors](#1242-seek-vs-scan-behaviors)
- [12.5 SARGability](#125-sargability)
  - [12.5.1 Avoid Functions on Indexed Columns](#1251-avoid-functions-on-indexed-columns)
  - [12.5.2 Predicate Rewrites for Index Usage](#1252-predicate-rewrites-for-index-usage)
