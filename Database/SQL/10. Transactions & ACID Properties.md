...
- [10.1 Transaction Lifecycle](#101-transaction-lifecycle)
  - [10.1.1 BEGIN, COMMIT, ROLLBACK](#1011-begin-commit-rollback)
  - [10.1.2 Savepoints and Nesting](#1012-savepoints-and-nesting)
- [10.2 ACID Guarantees](#102-acid-guarantees)
  - [10.2.1 Atomicity & Consistency](#1021-atomicity-consistency)
  - [10.2.2 Isolation & Durability](#1022-isolation-durability)
  - [10.2.3 Write-Ahead Logging (WAL) and Crash Recovery](#1023-write-ahead-logging-wal-and-crash-recovery)
- [10.3 Two-Phase Commit (2PC)](#103-two-phase-commit-2pc)
  - [10.3.1 Prepare and Commit Phases](#1031-prepare-and-commit-phases)
  - [10.3.2 Coordinator Failures and Recovery](#1032-coordinator-failures-and-recovery)
- [10.4 Isolation Anomalies](#104-isolation-anomalies)
  - [10.4.1 Dirty, Non-repeatable, Phantom Reads](#1041-dirty-non-repeatable-phantom-reads)
  - [10.4.2 Lost Update and Write Skew](#1042-lost-update-and-write-skew)
