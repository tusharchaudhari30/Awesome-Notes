...
- [4.1 INSERT Operations](#41-insert-operations)
  - [4.1.1 Single-row vs Multi-row Inserts](#411-single-row-vs-multi-row-inserts)
  - [4.1.2 Bulk Loads and Performance](#412-bulk-loads-and-performance)
- [4.2 UPDATE Techniques](#42-update-techniques)
  - [4.2.1 UPDATE with JOINs](#421-update-with-joins)
  - [4.2.2 UPDATE with Subqueries](#422-update-with-subqueries)
- [4.3 DELETE & MERGE](#43-delete-merge)
  - [4.3.1 DELETE vs TRUNCATE](#431-delete-vs-truncate)
  - [4.3.2 MERGE (Upsert) Patterns](#432-merge-upsert-patterns)
- [4.4 Transactional DML](#44-transactional-dml)
  - [4.4.1 Savepoints & Nested Transactions](#441-savepoints-nested-transactions)
  - [4.4.2 Error Handling and Rollbacks](#442-error-handling-and-rollbacks)
- [4.5 Temporary Objects](#45-temporary-objects)
  - [4.5.1 Temporary Tables and Table Variables](#451-temporary-tables-and-table-variables)
  - [4.5.2 CTEs vs Temp Tables Trade-offs](#452-ctes-vs-temp-tables-trade-offs)
