...
- [8.1 Ranking Functions](#81-ranking-functions)
  - [8.1.1 ROW_NUMBER(), RANK(), DENSE_RANK()](#811-row_number-rank-dense_rank)
  - [8.1.2 NTILE() Distributions](#812-ntile-distributions)
- [8.2 Aggregate OVER()](#82-aggregate-over)
  - [8.2.1 SUM() OVER Partitions](#821-sum-over-partitions)
  - [8.2.2 AVG() OVER Orderings](#822-avg-over-orderings)
- [8.3 Window Clauses](#83-window-clauses)
  - [8.3.1 PARTITION BY](#831-partition-by)
  - [8.3.2 ORDER BY and Frame (ROWS vs RANGE)](#832-order-by-and-frame-rows-vs-range)
- [8.4 Analytical Patterns](#84-analytical-patterns)
  - [8.4.1 Running Totals and Moving Averages](#841-running-totals-and-moving-averages)
  - [8.4.2 Gaps-and-Islands Problems](#842-gaps-and-islands-problems)
