...
- [15.1 Triggers](#151-triggers)
  - [15.1.1 BEFORE, AFTER, INSTEAD OF Triggers](#1511-before-after-instead-of-triggers)
  - [15.1.2 Row-level vs Statement-level Triggers](#1512-row-level-vs-statement-level-triggers)
- [15.2 User-Defined Functions](#152-user-defined-functions)
  - [15.2.1 Scalar, Inline Table, Multi-Statement Functions](#1521-scalar-inline-table-multi-statement-functions)
  - [15.2.2 Deterministic vs Non-Deterministic Functions](#1522-deterministic-vs-non-deterministic-functions)
- [15.3 Audit & Automation Patterns](#153-audit-automation-patterns)
  - [15.3.1 Change Logging Strategies](#1531-change-logging-strategies)
  - [15.3.2 Pitfalls and Performance Costs](#1532-pitfalls-and-performance-costs)
- [Best Practices for Triggers & Functions](#best-practices-for-triggers-functions)
- [Summary](#summary)
