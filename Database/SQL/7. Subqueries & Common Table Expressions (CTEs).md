...
- [7.1 Subquery Types](#71-subquery-types)
  - [7.1.1 Single-row vs Multi-row Subqueries](#711-single-row-vs-multi-row-subqueries)
  - [7.1.2 Correlated vs Uncorrelated Subqueries](#712-correlated-vs-uncorrelated-subqueries)
- [7.2 Common Table Expressions (CTEs)](#72-common-table-expressions-ctes)
  - [7.2.1 Non-recursive CTEs](#721-non-recursive-ctes)
  - [7.2.2 Recursive CTEs](#722-recursive-ctes)
- [7.3 Derived Tables & Inline Views](#73-derived-tables-inline-views)
  - [7.3.1 Derived Tables](#731-derived-tables)
  - [7.3.2 Inline Views vs CTEs](#732-inline-views-vs-ctes)
