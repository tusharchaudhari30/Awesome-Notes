...
- [9.1 Normal Forms](#91-normal-forms)
  - [9.1.1 First Normal Form (1NF) & Second Normal Form (2NF)](#911-first-normal-form-1nf-second-normal-form-2nf)
  - [9.1.2 Third Normal Form (3NF) & Boyce-Codd Normal Form (BCNF)](#912-third-normal-form-3nf-boyce-codd-normal-form-bcnf)
- [9.2 Functional Dependencies](#92-functional-dependencies)
  - [9.2.1 Identifying and Testing Functional Dependencies](#921-identifying-and-testing-functional-dependencies)
  - [9.2.2 Minimal Cover and Inference Rules](#922-minimal-cover-and-inference-rules)
- [9.3 Denormalization](#93-denormalization)
  - [9.3.1 Use Cases and Patterns](#931-use-cases-and-patterns)
  - [9.3.2 Materialized Views vs Redundant Columns](#932-materialized-views-vs-redundant-columns)
- [9.4 Surrogate vs Natural Keys](#94-surrogate-vs-natural-keys)
  - [9.4.1 Trade-offs and Stability](#941-trade-offs-and-stability)
  - [9.4.2 Impact on Joins and Indexes](#942-impact-on-joins-and-indexes)
- [9.5 ER-to-Relational Mapping](#95-er-to-relational-mapping)
  - [9.5.1 One-to-One, One-to-Many, Many-to-Many Relationships](#951-one-to-one-one-to-many-many-to-many-relationships)
  - [9.5.2 Junction Tables and Constraints](#952-junction-tables-and-constraints)
- [Common Interview Scenarios](#common-interview-scenarios)
  - [Normalization Process Example](#normalization-process-example)
