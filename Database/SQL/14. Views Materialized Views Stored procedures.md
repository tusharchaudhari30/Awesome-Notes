...
- [14.1 Views](#141-views)
  - [14.1.1 Inline vs Indexed Views](#1411-inline-vs-indexed-views)
  - [14.1.2 Security & Ownership Chaining](#1412-security-ownership-chaining)
- [14.2 Materialized Views](#142-materialized-views)
  - [14.2.1 Refresh Options: On Commit/Interval/Manual](#1421-refresh-options-on-commitintervalmanual)
  - [14.2.2 Storage and Staleness Trade-Offs](#1422-storage-and-staleness-trade-offs)
- [14.3 Stored Procedures & Functions](#143-stored-procedures-functions)
  - [14.3.1 Parameters, Overloading, Error Handling](#1431-parameters-overloading-error-handling)
  - [14.3.2 Transaction Scope and Side-Effects](#1432-transaction-scope-and-side-effects)
- [14.4 MERGE/Upsert Patterns](#144-mergeupsert-patterns)
- [Summary](#summary)
