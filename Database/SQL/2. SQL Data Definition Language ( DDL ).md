...
- [ALTER Statements](#alter-statements)
  ...
  - [ADD/DROP/MODIFY Constraints](#adddropmodify-constraints)
- [DROP & TRUNCATE](#drop-truncate)
  - [DROP Objects](#drop-objects)
  - [TRUNCATE vs DELETE](#truncate-vs-delete)
- [Rename and CTAS](#rename-and-ctas)
  - [RENAME TABLE/COLUMN](#rename-tablecolumn)
  - [CREATE TABLE AS SELECT (CTAS)](#create-table-as-select-ctas)
- [Sequences & Identity Columns](#sequences-identity-columns)
