...
- [11.1 Locking Mechanisms](#111-locking-mechanisms)
  - [11.1.1 Pessimistic vs Optimistic Locking](#1111-pessimistic-vs-optimistic-locking)
  - [11.1.2 Row-level, Page-level, Table-level Locks](#1112-row-level-page-level-table-level-locks)
- [11.2 Deadlocks](#112-deadlocks)
  - [11.2.1 Detection Algorithms](#1121-detection-algorithms)
  - [11.2.2 Resolution Strategies](#1122-resolution-strategies)
- [11.3 MVCC & Snapshot Isolation](#113-mvcc-snapshot-isolation)
  - [11.3.1 Version Chains and Readers-Writers](#1131-version-chains-and-readers-writers)
  - [11.3.2 Phantom Prevention Approaches](#1132-phantom-prevention-approaches)
- [11.4 Optimistic Concurrency Tokens](#114-optimistic-concurrency-tokens)
  - [11.4.1 Rowversion/Timestamp, ETags](#1141-rowversiontimestamp-etags)
  - [11.4.2 Compare-and-Swap Patterns](#1142-compare-and-swap-patterns)
