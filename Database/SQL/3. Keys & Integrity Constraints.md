...
- [Key Types](#key-types)
  - [Primary, Candidate, Alternate Keys](#primary-candidate-alternate-keys)
...
- [Referential Actions](#referential-actions)
  - [ON DELETE/UPDATE CASCADE/SET NULL/RESTRICT](#on-deleteupdate-cascadeset-nullrestrict)
  - [Deferrable and Initially Deferred Constraints](#deferrable-and-initially-deferred-constraints)
- [Common Interview Scenarios](#common-interview-scenarios)
  - [Choosing Primary vs Alternate Keys](#choosing-primary-vs-alternate-keys)
  - [Composite Key Design Patterns](#composite-key-design-patterns)
