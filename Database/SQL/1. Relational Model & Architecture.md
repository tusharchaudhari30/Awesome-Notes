...
- [Definitions](#definitions)
  - [Relation, Tuple, Attribute](#relation-tuple-attribute)
...
- [Codd’s 12 Rules](#codds-12-rules)
  - [Information, Guaranteed Access, NULL Treatment](#information-guaranteed-access-null-treatment)
  - [Data Sublanguage, View Update Rule](#data-sublanguage-view-update-rule)
- [ER Modeling](#er-modeling)
  - [Entities, Attributes, Relationships](#entities-attributes-relationships)
  - [Weak Entities and Identifying Relationships](#weak-entities-and-identifying-relationships)
- [Common Interview Pitfalls](#common-interview-pitfalls)
  - [Concept vs Implementation](#concept-vs-implementation)
  - [NULL and Keys](#null-and-keys)
- [Quick SQL Examples](#quick-sql-examples)
  - [Selection and Projection](#selection-and-projection)
  - [Basic Join (Conceptual to Relational)](#basic-join-conceptual-to-relational)
  - [Updatable View Example](#updatable-view-example)
  - [Handling NULLs Carefully](#handling-nulls-carefully)
