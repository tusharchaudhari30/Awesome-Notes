...
- [13.1 Execution Phases](#131-execution-phases)
  - [13.1.1 Parsing & Validation](#1311-parsing-validation)
  - [13.1.2 Optimization & Plan Generation](#1312-optimization-plan-generation)
  - [13.1.3 Execution & Result Retrieval](#1313-execution-result-retrieval)
- [13.2 Plans & Join Algorithms](#132-plans-join-algorithms)
  - [13.2.1 Logical vs Physical Operators](#1321-logical-vs-physical-operators)
  - [13.2.2 Nested Loop, Hash, Merge Joins](#1322-nested-loop-hash-merge-joins)
- [13.3 Hints & Rewriting](#133-hints-rewriting)
  - [13.3.1 Index and Join Hints](#1331-index-and-join-hints)
  - [13.3.2 Query Refactoring Patterns](#1332-query-refactoring-patterns)
- [13.4 Engine-Specific Top-N & Pagination](#134-engine-specific-top-n-pagination)
  - [13.4.1 LIMIT/OFFSET, TOP, FETCH FIRST](#1341-limitoffset-top-fetch-first)
  - [13.4.2 Keyset Pagination for Performance](#1342-keyset-pagination-for-performance)
- [13.5 Statistics Management](#135-statistics-management)
  - [13.5.1 Auto-Stats and Stale Statistics Issues](#1351-auto-stats-and-stale-statistics-issues)
  - [13.5.2 Cardinality Estimation Pitfalls](#1352-cardinality-estimation-pitfalls)
- [Summary](#summary)
