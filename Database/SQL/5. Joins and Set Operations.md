...
- [Sample Input Tables for All Examples](#sample-input-tables-for-all-examples)
- [5.1 Join Types](#51-join-types)
  - [5.1.1 Inner, Left, Right, Full Joins](#511-inner-left-right-full-joins)
  - [5.1.2 Cross & Self-Joins](#512-cross-self-joins)
  - [5.1.3 Semi-Join & Anti-Join via EXISTS/NOT EXISTS](#513-semi-join-anti-join-via-existsnot-exists)
- [5.2 Set Operators](#52-set-operators)
  - [5.2.1 UNION vs UNION ALL](#521-union-vs-union-all)
  - [5.2.2 INTERSECT & EXCEPT](#522-intersect-except)
- [5.3 Performance Considerations](#53-performance-considerations)
  - [5.3.1 Join Order & Join Hints](#531-join-order-join-hints)
  - [5.3.2 Index Usage & Statistics](#532-index-usage-statistics)
- [5.4 Lateral Joins](#54-lateral-joins)
  - [5.4.1 CROSS APPLY/OUTER APPLY](#541-cross-applyouter-apply)
  - [5.4.2 UNNEST/ARRAY Operations (PostgreSQL)](#542-unnestarray-operations-postgresql)
- [Key Performance Tips for Joins](#key-performance-tips-for-joins)
