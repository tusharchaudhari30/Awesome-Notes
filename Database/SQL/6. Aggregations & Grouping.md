...
- [6.1 GROUP BY & HAVING](#61-group-by-having)
  - [6.1.1 Basic GROUP BY](#611-basic-group-by)
  - [6.1.2 HAVING Filters](#612-having-filters)
- [6.2 Aggregate Functions](#62-aggregate-functions)
  - [6.2.1 SUM, COUNT, AVG](#621-sum-count-avg)
  - [6.2.2 MIN, MAX, STDDEV, VARIANCE](#622-min-max-stddev-variance)
- [6.3 Advanced Grouping](#63-advanced-grouping)
  - [6.3.1 ROLLUP & CUBE](#631-rollup-cube)
  - [6.3.2 GROUPING SETS & GROUPING_ID](#632-grouping-sets-grouping_id)
- [6.4 DISTINCT vs GROUP BY](#64-distinct-vs-group-by)
  - [6.4.1 DISTINCT De-duplication Semantics](#641-distinct-de-duplication-semantics)
  - [6.4.2 Performance Trade-offs](#642-performance-trade-offs)
