...
- [2.1 Persistence Mechanisms - RDB Snapshots vs AOF](#21-persistence-mechanisms-rdb-snapshots-vs-aof)
  - [RDB (Redis Database) Snapshots](#rdb-redis-database-snapshots)
  - [AOF (Append-Only File)](#aof-append-only-file)
  - [AOF Rewrite](#aof-rewrite)
- [2.2 AOF Rewrite and fsync Policies](#22-aof-rewrite-and-fsync-policies)
  - [Understanding fsync Behavior](#understanding-fsync-behavior)
  - [AOF Rewrite Process](#aof-rewrite-process)
  - [Hybrid Persistence (RDB + AOF)](#hybrid-persistence-rdb-aof)
- [2.3 Data Durability Trade-offs and Performance Impact](#23-data-durability-trade-offs-and-performance-impact)
  - [Durability vs Performance Matrix](#durability-vs-performance-matrix)
  - [Performance Considerations](#performance-considerations)
- [2.4 Redis Replication (Master-Slave Architecture)](#24-redis-replication-master-slave-architecture)
  - [Master-Slave Replication Overview](#master-slave-replication-overview)
  - [Replication Process](#replication-process)
  - [Replication ID and Offset](#replication-id-and-offset)
  - [Configuration](#configuration)
- [2.5 Replication Offset and Partial Resynchronization](#25-replication-offset-and-partial-resynchronization)
  - [Understanding Replication Offset](#understanding-replication-offset)
  - [Partial Resynchronization Process](#partial-resynchronization-process)
  - [Backlog Management](#backlog-management)
  - [Common Partial Resync Failures](#common-partial-resync-failures)
- [2.6 Redis Sentinel for Automatic Failover](#26-redis-sentinel-for-automatic-failover)
  - [What is Redis Sentinel?](#what-is-redis-sentinel)
  - [Sentinel Quorum Concept](#sentinel-quorum-concept)
  - [Sentinel Configuration](#sentinel-configuration)
  - [Failover Process](#failover-process)
  - [Replica Selection Logic](#replica-selection-logic)
- [2.7 Sentinel Configuration and Monitoring](#27-sentinel-configuration-and-monitoring)
  - [Key Sentinel Directives](#key-sentinel-directives)
  - [Sentinel Monitoring Commands](#sentinel-monitoring-commands)
  - [Monitoring and Alerts](#monitoring-and-alerts)
- [2.8 Redis Cluster for Horizontal Scaling and Sharding](#28-redis-cluster-for-horizontal-scaling-and-sharding)
...
- [2.9 Cluster Slots and Hash Tags](#29-cluster-slots-and-hash-tags)
  - [Slot Management Commands](#slot-management-commands)
  - [Hash Tags for Slot Locality](#hash-tags-for-slot-locality)
- [2.10 Cluster Failover and Topology Changes](#210-cluster-failover-and-topology-changes)
  - [Cluster Failover Process](#cluster-failover-process)
  - [Topology Changes](#topology-changes)
  - [Resharding and Rebalancing](#resharding-and-rebalancing)
  - [Cluster Client Redirection](#cluster-client-redirection)
