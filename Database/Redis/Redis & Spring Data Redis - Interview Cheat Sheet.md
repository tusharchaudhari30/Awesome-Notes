...
- [Redis Data Structures](#redis-data-structures)
  ...
  - [2. List](#2-list)
  - [3. Set](#3-set)
  - [4. Sorted Set (ZSet)](#4-sorted-set-zset)
  - [5. Hash](#5-hash)
- [Redis Key Management](#redis-key-management)
...
- [Spring Data Redis Configuration](#spring-data-redis-configuration)
  - [Maven Dependencies](#maven-dependencies)
  - [application.properties](#applicationproperties)
- [Spring Data Redis - RedisTemplate](#spring-data-redis-redistemplate)
  - [Basic Configuration](#basic-configuration)
  - [Using RedisTemplate](#using-redistemplate)
- [Spring Data Redis - Caching](#spring-data-redis-caching)
  - [Enable Caching](#enable-caching)
  - [Cache Annotations](#cache-annotations)
- [Spring Data Redis - Repository Pattern](#spring-data-redis-repository-pattern)
  - [Entity with @RedisHash](#entity-with-redishash)
  - [Repository Interface](#repository-interface)
  - [Enable Redis Repositories](#enable-redis-repositories)
  - [Using Repository](#using-repository)
- [Spring Data Redis - Pub/Sub](#spring-data-redis-pubsub)
  - [Message Listener](#message-listener)
  - [Configuration](#configuration)
  - [Publishing Messages](#publishing-messages)
- [Spring Data Redis - Pipelining](#spring-data-redis-pipelining)
- [Spring Data Redis - Transactions](#spring-data-redis-transactions)
- [Common Interview Questions](#common-interview-questions)
  - [1. Why use Redis?](#1-why-use-redis)
  - [2. Redis vs Memcached?](#2-redis-vs-memcached)
  - [3. When to use Redis caching?](#3-when-to-use-redis-caching)
  - [4. Redis Cluster vs Sentinel?](#4-redis-cluster-vs-sentinel)
  - [5. Redis single-threaded - is it a limitation?](#5-redis-single-threaded-is-it-a-limitation)
