...
- [3.1 Redis Transactions (MULTI, EXEC, WATCH, DISCARD)](#31-redis-transactions-multi-exec-watch-discard)
  - [MULTI and EXEC](#multi-and-exec)
  - [Basic Transaction Pattern](#basic-transaction-pattern)
  - [QUEUED Response](#queued-response)
  - [DISCARD Command](#discard-command)
  - [Transaction Guarantees and Limitations](#transaction-guarantees-and-limitations)
  - [Transaction Error Handling](#transaction-error-handling)
- [3.2 Optimistic Locking with WATCH](#32-optimistic-locking-with-watch)
  - [WATCH Mechanism](#watch-mechanism)
  - [Basic WATCH Pattern](#basic-watch-pattern)
  - [Multi-Key WATCH](#multi-key-watch)
  - [UNWATCH Command](#unwatch-command)
  - [Common Use Case: Atomic Increment with Check](#common-use-case-atomic-increment-with-check)
  - [WATCH Behavior](#watch-behavior)
  - [Real-World Example: Bank Transfer](#real-world-example-bank-transfer)
- [3.3 Pub/Sub Messaging Pattern](#33-pubsub-messaging-pattern)
  - [Core Concepts](#core-concepts)
  - [Basic Pub/Sub Operations](#basic-pubsub-operations)
  - [Message Format](#message-format)
  - [Pattern-Based Subscriptions (PSUBSCRIBE)](#pattern-based-subscriptions-psubscribe)
  - [Pub/Sub Limitations](#pubsub-limitations)
  - [Use Cases](#use-cases)
- [3.4 Pub/Sub vs Streams Comparison](#34-pubsub-vs-streams-comparison)
- [3.5 Pipelining for Bulk Operations](#35-pipelining-for-bulk-operations)
  ...
  - [Transaction vs Non-Transaction Pipelines](#transaction-vs-non-transaction-pipelines)
- [3.6 Memory Management and Eviction Policies (LRU, LFU, TTL)](#36-memory-management-and-eviction-policies-lru-lfu-ttl)
  - [Memory Configuration](#memory-configuration)
  - [Eviction Policy Types](#eviction-policy-types)
  - [Eviction Policy Selection Matrix](#eviction-policy-selection-matrix)
  - [LFU Configuration](#lfu-configuration)
  - [Memory Analysis](#memory-analysis)
- [3.7 MEMORY Commands and Analysis](#37-memory-commands-and-analysis)
  - [Memory Information Commands](#memory-information-commands)
  - [Memory Optimization Strategies](#memory-optimization-strategies)
- [3.8 Redis Lua Scripting and EVAL](#38-redis-lua-scripting-and-eval)
  - [EVAL Command](#eval-command)
  - [Accessing Keys and Arguments](#accessing-keys-and-arguments)
  - [Redis Command Execution in Lua](#redis-command-execution-in-lua)
  - [Atomic Counter with Limit](#atomic-counter-with-limit)
  - [Script Caching with EVALSHA](#script-caching-with-evalsha)
- [3.9 Atomic Operations with Lua Scripts](#39-atomic-operations-with-lua-scripts)
  - [Atomic Transfer with Conditions](#atomic-transfer-with-conditions)
  - [Rate Limiting Script](#rate-limiting-script)
- [3.10 Redis Security (AUTH, ACL, SSL/TLS, Network Isolation)](#310-redis-security-auth-acl-ssltls-network-isolation)
  - [Simple Password Authentication (AUTH)](#simple-password-authentication-auth)
  - [Access Control Lists (ACL) - Redis 6+](#access-control-lists-acl-redis-6)
  - [ACL Configuration](#acl-configuration)
  - [Built-in ACL Users](#built-in-acl-users)
  - [Command Categories](#command-categories)
  - [ACL Best Practices](#acl-best-practices)
  - [TLS/SSL Encryption](#tlsssl-encryption)
  - [Network Isolation](#network-isolation)
  - [Security Checklist](#security-checklist)
- [3.11 Key Expiration and TTL Management](#311-key-expiration-and-ttl-management)
  - [Setting Expiration](#setting-expiration)
  - [Checking TTL](#checking-ttl)
  - [Removing Expiration](#removing-expiration)
  - [Expiration Behavior](#expiration-behavior)
  - [TTL Strategy Patterns](#ttl-strategy-patterns)
- [3.12 Scanning Keys Efficiently (SCAN vs KEYS)](#312-scanning-keys-efficiently-scan-vs-keys)
  - [KEYS Command (Don't Use in Production)](#keys-command-dont-use-in-production)
  - [SCAN Command (Production-Safe)](#scan-command-production-safe)
  - [SCAN Iterator Pattern](#scan-iterator-pattern)
  - [SCAN Guarantees and Limitations](#scan-guarantees-and-limitations)
  - [SCAN Variants](#scan-variants)
