...
- [4.1 Spring Data Redis Dependencies and Setup](#41-spring-data-redis-dependencies-and-setup)
  - [Adding Maven Dependencies](#adding-maven-dependencies)
  - [Basic Configuration](#basic-configuration)
  - [Auto-Configuration](#auto-configuration)
- [4.2 RedisTemplate and StringRedisTemplate Operations](#42-redistemplate-and-stringredistemplate-operations)
  - [RedisTemplate Overview](#redistemplate-overview)
  - [Basic RedisTemplate Configuration](#basic-redistemplate-configuration)
  - [ValueOperations (String Commands)](#valueoperations-string-commands)
  - [HashOperations (Hash Commands)](#hashoperations-hash-commands)
  - [ListOperations (List Commands)](#listoperations-list-commands)
  - [SetOperations (Set Commands)](#setoperations-set-commands)
  - [ZSetOperations (Sorted Set Commands)](#zsetoperations-sorted-set-commands)
  - [StringRedisTemplate](#stringredistemplate)
- [4.3 Redis Repositories with CrudRepository](#43-redis-repositories-with-crudrepository)
  - [CrudRepository Pattern](#crudrepository-pattern)
  - [Entity Definition with @RedisHash](#entity-definition-with-redishash)
  - [Creating Repository](#creating-repository)
  - [Using Repository](#using-repository)
  - [Repository Key Storage](#repository-key-storage)
- [4.4 @RedisHash Annotation for Entity Mapping](#44-redishash-annotation-for-entity-mapping)
  - [@RedisHash Configuration](#redishash-configuration)
  - [Field Annotations](#field-annotations)
  - [Nested Objects](#nested-objects)
  - [Time-To-Live (TTL)](#time-to-live-ttl)
- [4.5 Redis Connection Factory Configuration](#45-redis-connection-factory-configuration)
  - [Connection Factory Types](#connection-factory-types)
  - [Advanced Configuration](#advanced-configuration)
  - [SSL/TLS Configuration](#ssltls-configuration)
- [4.6 Jedis vs Lettuce Clients Comparison](#46-jedis-vs-lettuce-clients-comparison)
  - [Performance Characteristics](#performance-characteristics)
  - [When to Use Each](#when-to-use-each)
- [4.7 Connection Pooling and Configuration](#47-connection-pooling-and-configuration)
  - [Jedis Connection Pool](#jedis-connection-pool)
  - [Lettuce Connection Pool](#lettuce-connection-pool)
  - [Pool Sizing Guidelines](#pool-sizing-guidelines)
- [4.8 RedisMessageListenerContainer for Pub/Sub](#48-redismessagelistenercontainer-for-pubsub)
  - [Configuration](#configuration)
  - [Message Listener Adapter](#message-listener-adapter)
  - [Channel Topics](#channel-topics)
- [4.9 Message Listeners and Handlers](#49-message-listeners-and-handlers)
  - [Basic Message Listener](#basic-message-listener)
  - [Using SubscriptionListener](#using-subscriptionlistener)
- [4.10 Redis Transactions in Spring](#410-redis-transactions-in-spring)
  - [Using @Transactional](#using-transactional)
  - [Using SessionCallback](#using-sessioncallback)
- [4.11 Spring Data Redis Serialization (Jackson, Kryo, JdkSerialization)](#411-spring-data-redis-serialization-jackson-kryo-jdkserialization)
...
- [4.12 Custom Serialization Strategies](#412-custom-serialization-strategies)
  - [Type-Specific Serialization](#type-specific-serialization)
  - [Conditional Serialization by Key Pattern](#conditional-serialization-by-key-pattern)
  - [Compression with Serialization](#compression-with-serialization)
