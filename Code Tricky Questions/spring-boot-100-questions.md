...
1. [Bean Lifecycle & Scopes (Questions 1-10)](#bean-lifecycle--scopes)
2. [Dependency Injection (Questions 11-20)](#dependency-injection)
3. [Configuration & Properties (Questions 21-30)](#configuration--properties)
4. [AOP - Aspect Oriented Programming (Questions 31-40)](#aop---aspect-oriented-programming)
5. [Spring Data JPA & Hibernate (Questions 41-50)](#spring-data-jpa--hibernate)
6. [Transaction Management (Questions 51-60)](#transaction-management)
7. [REST API & Exception Handling (Questions 61-70)](#rest-api--exception-handling)
8. [Validation & Security (Questions 71-80)](#validation--security)
9. [Caching & Async Programming (Questions 81-90)](#caching--async-programming)
10. [Testing & Advanced Topics (Questions 91-100)](#testing--advanced-topics)
