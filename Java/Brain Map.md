...
- [Collections Framework (Complete)](#4-collections-framework-complete)
  - [Core interfaces (Collection, List, Set, Map, Queue, Deque, Navigable/Sorted variants)](#core-interfaces)
  - [Abstract base classes](#abstract-base-classes)
  - [Implementations (ArrayList, LinkedList, HashSet, TreeSet, ArrayDeque, PriorityQueue, HashMap, TreeMap, etc.)](#list-implementations)
  - [Concurrent collections and special-purpose collections](#concurrent-collections-and-special-purpose-collections)
  - [Quick contrasts & code snippets](#quick-contrasts-in-code)
- [Functional Programming (java.util.function)](#1-functional-programming-javautilfunction)
  ...
  - [Default Methods & Combinations](#12-default-methods--combinations)
- [Streams API](#2-streams-api)
  - [Stream Creation](#21-stream-creation)
  - [Intermediate Operations](#22-intermediate-operations)
    - [Filtering & Mapping](#filtering--mapping)
    - [Sorting & Limiting](#sorting--limiting)
    - [Debugging (peek)](#debugging-operations)
  - [Terminal Operations](#23-terminal-operations)
    - [Collecting Results](#collecting-results)
    - [Reduction Operations](#reduction-operations)
    - [Finding Operations](#finding-operations)
    - [forEach Operations](#foreach-operations)
  - [Primitive Streams (IntStream, LongStream, DoubleStream)](#24-primitive-streams)
  - [Collectors Class (basic, statistical, grouping/partitioning, advanced)](#25-collectors-class-complete-list)
- [Threading & Concurrency (java.util.concurrent)](#3-threading--concurrency-javautilconcurrent)
  - [Core Thread Classes (Thread, Runnable)](#31-core-thread-classes)
  - [Executor Framework (Executor, ExecutorService, ScheduledExecutorService, factory methods)](#32-executor-framework)
  - [Concurrent Collections (thread-safe lists, sets, maps)](#33-concurrent-collections)
  - [Blocking Queues & Deques](#34-blocking-queues)
  - [Synchronization Utilities (CountDownLatch, CyclicBarrier, Semaphore, Exchanger, Phaser)](#36-synchronization-utilities)
  - [Locks & Atomic Variables (ReentrantLock, ReadWriteLock, StampedLock, Atomic classes)](#37-locks--atomic-variables)
  - [CompletableFuture (creation, chaining, combining)](#38-completablefuture-java-8)
...
## Table of Contents
  ...
  - [Core Java Concepts](#core-java-concepts)
  - [Core Java Concepts](#core-java-concepts-1)
  - [JVM, JRE, JDK](#jvm-jre-jdk)
  - [Data Types](#data-types)
  - [Control Structures](#control-structures)
  - [Exception Handling](#exception-handling)
  ...
  - [Polymorphism](#polymorphism)
  - [Interfaces and Abstract Classes](#interfaces-and-abstract-classes)
- [**4. Collections Framework (Complete)**](#4-collections-framework-complete)
- [**Abstract base classes**](#abstract-base-classes)
- [**List implementations**](#list-implementations)
- [**Set implementations**](#set-implementations)
- [**Queue/Deque implementations**](#queuedeque-implementations)
- [**Map implementations**](#map-implementations)
- [**Concurrent maps**](#concurrent-maps)
- [**Concurrent lists/sets**](#concurrent-listssets)
- [**Special-purpose collections**](#special-purpose-collections)
- [**1. Functional Programming (java.util.function)**](#1-functional-programming-javautilfunction)
  - [**1.1 Core Functional Interfaces**](#11-core-functional-interfaces)
  - [** Custom Functional Interface**](#custom-functional-interface)
  - [**Basic Four Operations**](#basic-four-operations)
  - [**1.2 Default Methods & Combinations**](#12-default-methods-combinations)
- [**2. Streams API**](#2-streams-api)
  - [**2.1 Stream Creation**](#21-stream-creation)
  - [**2.2 Intermediate Operations**](#22-intermediate-operations)
  - [**Filtering & Mapping**](#filtering-mapping)
  - [**Sorting & Limiting**](#sorting-limiting)
  - [**Debugging Operations**](#debugging-operations)
  - [**2.3 Terminal Operations**](#23-terminal-operations)
  - [**Collecting Results**](#collecting-results)
  - [**Reduction Operations**](#reduction-operations)
  - [**Finding Operations**](#finding-operations)
  - [**forEach Operations**](#foreach-operations)
  - [**2.4 Primitive Streams**](#24-primitive-streams)
  - [**IntStream**](#intstream)
  - [**LongStream & DoubleStream**](#longstream-doublestream)
  - [**2.5 Collectors Class (Complete List)**](#25-collectors-class-complete-list)
  - [**Basic Collectors**](#basic-collectors)
  - [**Statistical Collectors**](#statistical-collectors)
  - [**Grouping & Partitioning**](#grouping-partitioning)
  - [**Advanced Collectors**](#advanced-collectors)
- [**3. Threading & Concurrency (java.util.concurrent)**](#3-threading-concurrency-javautilconcurrent)
  - [**3.1 Core Thread Classes**](#31-core-thread-classes)
  - [**Basic Threading**](#basic-threading)
  - [**3.2 Executor Framework**](#32-executor-framework)
  - [**Executor Interfaces**](#executor-interfaces)
  - [**Executors Factory Methods**](#executors-factory-methods)
  - [**3.3 Concurrent Collections**](#33-concurrent-collections)
  - [**Thread-Safe Lists**](#thread-safe-lists)
  - [**Thread-Safe Sets**](#thread-safe-sets)
  - [**Thread-Safe Maps**](#thread-safe-maps)
  - [**3.4 Blocking Queues**](#34-blocking-queues)
  - [**Queue Implementations**](#queue-implementations)
  - [**Queue Operations**](#queue-operations)
  - [**3.5 Deques**](#35-deques)
  - [**3.6 Synchronization Utilities**](#36-synchronization-utilities)
  - [**CountDownLatch**](#countdownlatch)
  - [**CyclicBarrier**](#cyclicbarrier)
  - [**Semaphore**](#semaphore)
  - [**Exchanger**](#exchanger)
  - [**Phaser (Java 7+)**](#phaser-java-7)
  - [**3.7 Locks & Atomic Variables**](#37-locks-atomic-variables)
  - [**ReentrantLock**](#reentrantlock)
  - [**ReadWriteLock**](#readwritelock)
  - [**StampedLock (Java 8+)**](#stampedlock-java-8)
  - [**Atomic Classes**](#atomic-classes)
  - [**3.8 CompletableFuture (Java 8+)**](#38-completablefuture-java-8)
  - [**Creation & Basic Operations**](#creation-basic-operations)
