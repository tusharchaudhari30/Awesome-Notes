...
- [2. Object - Oriented Programming](#2-object---oriented-programming)
  ...
  - [2.6 Abstraction](#26-abstraction)
    - [Example of Abtracts](#example-of-abtracts)
  - [2.7 `this` and `super`](#27-this-and-super)
  - [2.8 Static Variables and Methods](#28-static-variables-and-methods)
  - [2.9 Final Keyword](#29-final-keyword)
  - [2.10 Inner Classes](#210-inner-classes)
  - [2.11 Record (Java 14+)](#211-record-java-14)
  - [2.12 Enumeration (Enum)](#212-enumeration-enum)
  - [2.13 Annotations](#213-annotations)
