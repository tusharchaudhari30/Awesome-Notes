...
- [4.1 What is an Exception?](#41-what-is-an-exception)
- [4.2 Difference between Error and Exception](#42-difference-between-error-and-exception)
- [4.3 Types of Exceptions](#43-types-of-exceptions)
- [4.4 Exception Hierarchy](#44-exception-hierarchy)
- [4.5 Exception Handling Keywords](#45-exception-handling-keywords)
- [4.6 Example: try-catch](#46-example-try-catch)
- [4.7 Multiple Catch Blocks](#47-multiple-catch-blocks)
- [4.8 Finally Block](#48-finally-block)
- [4.9 Throw Keyword](#49-throw-keyword)
- [4.10 Throws Keyword](#410-throws-keyword)
- [4.11 Custom Exception](#411-custom-exception)
- [4.12 Try-With-Resources (Java 7+)](#412-try-with-resources-java-7)
- [4.13 Best Practices](#413-best-practices)
