...
- [5.1 Delivery models overview](#51-delivery-models-overview)
  - [5.1.1 At-most-once](#511-at-most-once)
  - [5.1.2 At-least-once](#512-at-least-once)
  - [5.1.3 Exactly-once (EOS)](#513-exactly-once-eos)
- [5.2 At-most-once in Spring for Kafka](#52-at-most-once-in-spring-for-kafka)
  - [5.2.1 Configuration](#521-configuration)
- [5.3 At-least-once in Spring for Kafka](#53-at-least-once-in-spring-for-kafka)
  - [5.3.1 Configuration](#531-configuration)
- [5.4 Exactly-once for producers (produce-only EOS)](#54-exactly-once-for-producers-produce-only-eos)
  - [5.4.1 Configuration](#541-configuration)
- [5.5 Exactly-once consume–process–produce (EOS) with transactions](#55-exactly-once-consumeprocessproduce-eos-with-transactions)
  - [5.5.1 Configuration](#551-configuration)
  - [5.5.2 Explicit transactional block (alternative)](#552-explicit-transactional-block-alternative)
- [5.6 Consumer isolation for transactions](#56-consumer-isolation-for-transactions)
  - [5.6.1 Read committed vs read uncommitted](#561-read-committed-vs-read-uncommitted)
- [5.7 Error handling with transactions](#57-error-handling-with-transactions)
  - [5.7.1 Retriable vs non-retriable exceptions](#571-retriable-vs-non-retriable-exceptions)
- [5.8 Fencing, timeouts, and best practices](#58-fencing-timeouts-and-best-practices)
  - [5.8.1 Producer fencing and transactional IDs](#581-producer-fencing-and-transactional-ids)
  - [5.8.2 Transaction timeouts](#582-transaction-timeouts)
- [5.9 Code comparison: at-least-once vs exactly-once](#59-code-comparison-at-least-once-vs-exactly-once)
  - [5.9.1 At-least-once (manual ack, no transaction)](#591-at-least-once-manual-ack-no-transaction)
  - [5.9.2 Exactly-once (transactional container, offsets + output atomically)](#592-exactly-once-transactional-container-offsets-output-atomically)
