...
- [6.1 Streams vs @KafkaListener](#61-streams-vs-kafkalistener)
  - [6.1.1 Mindset and use-cases](#611-mindset-and-use-cases)
  - [6.1.2 Code difference: listener vs streams](#612-code-difference-listener-vs-streams)
- [6.2 Streams essentials: KStream, KTable, GlobalKTable](#62-streams-essentials-kstream-ktable-globalktable)
  - [6.2.1 What they represent](#621-what-they-represent)
  - [6.2.2 Code: stream–table join](#622-code-streamtable-join)
- [6.3 Stateless vs Stateful](#63-stateless-vs-stateful)
  - [6.3.1 Stateless operations](#631-stateless-operations)
  - [6.3.2 Stateful operations and windows](#632-stateful-operations-and-windows)
- [6.4 Serdes and schemas](#64-serdes-and-schemas)
  - [6.4.1 Configuring Serdes in Spring](#641-configuring-serdes-in-spring)
- [6.5 Repartitioning and keys](#65-repartitioning-and-keys)
  - [6.5.1 Why repartition happens](#651-why-repartition-happens)
  - [6.5.2 Code: selectKey then group](#652-code-selectkey-then-group)
- [6.6 Exactly-once (EOS) in Streams](#66-exactly-once-eos-in-streams)
  - [6.6.1 Processing guarantee](#661-processing-guarantee)
- [6.7 Error handling in Streams](#67-error-handling-in-streams)
  - [6.7.1 Handling deserialization/production errors](#671-handling-deserializationproduction-errors)
  - [6.7.2 Code: validation branch to DLT](#672-code-validation-branch-to-dlt)
- [6.8 State stores and interactive queries](#68-state-stores-and-interactive-queries)
  - [6.8.1 Materialized store and querying](#681-materialized-store-and-querying)
- [6.9 Connect essentials (conceptual)](#69-connect-essentials-conceptual)
  - [6.9.1 What Kafka Connect solves](#691-what-kafka-connect-solves)
- [6.10 Choosing Streams vs Connect](#610-choosing-streams-vs-connect)
  - [6.10.1 Selection guide](#6101-selection-guide)
