...
- [4.1 Poll Loop, Heartbeats, Liveness](#41-poll-loop-heartbeats-liveness)
  - [4.1.1 Listener container basics](#411-listener-container-basics)
  - [4.1.2 Liveness-related configs](#412-liveness-related-configs)
- [4.2 Offset Management: Auto vs Manual Commit](#42-offset-management-auto-vs-manual-commit)
  - [4.2.1 Auto commit (simple, best-effort)](#421-auto-commit-simple-best-effort)
  - [4.2.2 Manual commit (at-least-once)](#422-manual-commit-at-least-once)
- [4.3 Seek, Replay, and Starting Position](#43-seek-replay-and-starting-position)
  - [4.3.1 Seeking on startup or on demand](#431-seeking-on-startup-or-on-demand)
- [4.4 Consumer Groups Deep Dive](#44-consumer-groups-deep-dive)
  - [4.4.1 What is a consumer group?](#441-what-is-a-consumer-group)
  - [4.4.2 Partition-to-member mapping](#442-partition-to-member-mapping)
  - [4.4.3 Rebalancing: eager vs cooperative](#443-rebalancing-eager-vs-cooperative)
- [4.5 Offsets: Storage, Ownership, and Semantics](#45-offsets-storage-ownership-and-semantics)
  - [4.5.1 Where offsets live and how to manage them](#451-where-offsets-live-and-how-to-manage-them)
  - [4.5.2 Reset policies and replay](#452-reset-policies-and-replay)
- [4.6 Throughput Tuning: Concurrency and Fetch](#46-throughput-tuning-concurrency-and-fetch)
  - [4.6.1 Concurrency scaling patterns](#461-concurrency-scaling-patterns)
  - [4.6.2 Fetch and flow control](#462-fetch-and-flow-control)
- [4.7 Error Handling, Retries, and DLT](#47-error-handling-retries-and-dlt)
  - [4.7.1 Blocking retries with DefaultErrorHandler](#471-blocking-retries-with-defaulterrorhandler)
  - [4.7.2 Non-blocking retries with @RetryableTopic](#472-non-blocking-retries-with-retryabletopic)
- [4.8 Pause/Resume and Backpressure](#48-pauseresume-and-backpressure)
  - [4.8.1 Pausing partitions safely](#481-pausing-partitions-safely)
- [4.9 Reading Only Committed Data](#49-reading-only-committed-data)
  - [4.9.1 Isolation level](#491-isolation-level)
- [4.10 Practical Checklist](#410-practical-checklist)
