# 8. Spring for Apache Kafka — Descriptive Explanations with Commented Code

## Table of Contents

- [1.1 Producers](#11-producers)
  - [1.1.1 KafkaTemplate](#111-kafkatemplate)
  - [1.1.2 RoutingKafkaTemplate](#112-routingkafkatemplate)
  - [1.1.3 ProducerFactory, DefaultKafkaProducerFactory, ProducerListener](#113-producerfactory-defaultkafkaproducerfactory-producerlistener)
- [1.2 Consumers](#12-consumers)
  - [1.2.1 @KafkaListener](#121-kafkalistener)
  - [1.2.2 KafkaListenerContainerFactory, ConcurrentKafkaListenerContainerFactory, KafkaMessageListenerContainer](#122-kafkalistenercontainerfactory-concurrentkafkalistenercontainerfactory-kafkamessagelistenercontainer)
  - [1.2.3 MessageListener, Acknowledgment, ConsumerFactory, DefaultKafkaConsumerFactory, ConsumerAwareListenerErrorHandler, RecordFilterStrategy](#123-messagelistener-acknowledgment-consumerfactory-defaultkafkaconsumerfactory-consumerawarelistenererrorhandler-recordfilterstrategy)
- [1.3 Listener containers and properties](#13-listener-containers-and-properties)
  - [1.3.1 ContainerProperties, CommonContainerStoppingErrorHandler, BatchErrorHandler, GenericMessageListenerContainer](#131-containerproperties-commoncontainerstoppingerrorhandler-batcherrorhandler-genericmessagelistenercontainer)
- [1.4 Error handling, retries, DLT](#14-error-handling-retries-dlt)
  - [1.4.1 DefaultErrorHandler, DeadLetterPublishingRecoverer, SeekToCurrentErrorHandler, BackOff, FixedBackOff, ExponentialBackOffWithMaxRetries, ErrorHandlingDeserializer, ErrorHandlingDeserializer2](#141-defaulterrorhandler-deadletterpublishingrecoverer-seektocurrenterrorhandler-backoff-fixedbackoff-exponentialbackoffwithmaxretries-errorhandlingdeserializer-errorhandlingdeserializer2)
- [1.5 Retryable topics](#15-retryable-topics)
  - [1.5.1 RetryableTopic, Backoff (annotation), DltHandler, TopicSuffixingStrategy](#151-retryabletopic-backoff-annotation-dlthandler-topicsuffixingstrategy)
  - [1.5.2 RetryTopicConfiguration, RetryTopicConfigurationBuilder](#152-retrytopicconfiguration-retrytopicconfigurationbuilder)
- [1.6 Transactions](#16-transactions)
  - [1.6.1 KafkaTransactionManager, KafkaAwareTransactionManager, ChainedKafkaTransactionManager, ProducerFactoryUtils](#161-kafkatransactionmanager-kafkaawaretransactionmanager-chainedkafkatransactionmanager-producerfactoryutils)
- [1.7 Admin and provisioning](#17-admin-and-provisioning)
  - [1.7.1 KafkaAdmin, NewTopic, TopicBuilder, AdminClientConfig](#171-kafkaadmin-newtopic-topicbuilder-adminclientconfig)
- [1.8 Messaging integration](#18-messaging-integration)
  - [1.8.1 KafkaHeaders, Messaging adapters and converters](#181-kafkaheaders-messaging-adapters-and-converters)
- [1.9 Events and lifecycle](#19-events-and-lifecycle)
  - [1.9.1 ListenerContainerIdleEvent, ConsumerPausedEvent, ConsumerResumedEvent, ConsumerStartedEvent, ConsumerStoppedEvent, NonResponsiveConsumerEvent, ContainerStoppedEvent](#191-listenercontaineridleevent-consumerpausedevent-consumerresumedevent-consumerstartedevent-consumerstoppedevent-nonresponsiveconsumerevent-containerstoppedevent)
- [1.10 Interceptors and observability](#110-interceptors-and-observability)
  - [1.10.1 ProducerInterceptor, ConsumerInterceptor, MicrometerProducerListener, MicrometerConsumerListener](#1101-producerinterceptor-consumerinterceptor-micrometerproducerlistener-micrometerconsumerlistener)
- [1.11 Kafka Streams integration](#111-kafka-streams-integration)
  - [1.11.1 EnableKafkaStreams, KafkaStreamsConfiguration, KafkaStreamsDefaultConfiguration, StreamsBuilderFactoryBean, KStream, KTable, GlobalKTable](#1111-enablekafkastreams-kafkastreamsconfiguration-kafkastreamsdefaultconfiguration-streamsbuilderfactorybean-kstream-ktable-globalktable)
- [1.12 Testing](#112-testing)
  - [1.12.1 EmbeddedKafka, EmbeddedKafkaBroker, KafkaTestUtils, OutputDestination](#1121-embeddedkafka-embeddedkafkabroker-kafkatestutils-outputdestination)
- [1.13 Serialization, conversion, and record types](#113-serialization-conversion-and-record-types)
  - [1.13.1 StringSerializer, StringDeserializer, ByteArraySerializer, ByteArrayDeserializer, JsonSerde, RecordHeaders, ConsumerRecord, ProducerRecord](#1131-stringserializer-stringdeserializer-bytearrayserializer-bytearraydeserializer-jsonserde-recordheaders-consumerrecord-producerrecord)
- [1.14 Utility and support](#114-utility-and-support)
  - [1.14.1 ContainerProperties.AckMode, RecordInterceptor, AfterRollbackProcessor, SeekingStatus, DeliveryAttemptHeader, RetryListener](#1141-containerpropertiesackmode-recordinterceptor-afterrollbackprocessor-seekingstatus-deliveryattemptheader-retrylistener)
