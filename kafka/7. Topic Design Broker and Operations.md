...
- [7.1 Brokers and Multi-Broker Clusters](#71-brokers-and-multi-broker-clusters)
  - [7.1.1 Broker roles and partition leadership](#711-broker-roles-and-partition-leadership)
  - [7.1.2 Multi-broker setup and rack awareness](#712-multi-broker-setup-and-rack-awareness)
- [7.2 Topic Design: Partitions, Replication, Capacity](#72-topic-design-partitions-replication-capacity)
  - [7.2.1 Partitions](#721-partitions)
  - [7.2.2 Replication and ISR](#722-replication-and-isr)
- [7.3 Retention Policies: Delete, Compact, Mixed](#73-retention-policies-delete-compact-mixed)
  - [7.3.1 Delete-based retention](#731-delete-based-retention)
  - [7.3.2 Log compaction](#732-log-compaction)
  - [7.3.3 Mixed mode](#733-mixed-mode)
- [7.4 Keys, Schemas, and Contracts](#74-keys-schemas-and-contracts)
  - [7.4.1 Keys and ordering](#741-keys-and-ordering)
  - [7.4.2 Schema registry and compatibility](#742-schema-registry-and-compatibility)
- [7.5 Provisioning Topics with Spring](#75-provisioning-topics-with-spring)
  - [7.5.1 KafkaAdmin/NewTopic](#751-kafkaadminnewtopic)
  - [7.5.2 Compacted and mixed topics](#752-compacted-and-mixed-topics)
- [7.6 Operations: Monitoring and Troubleshooting](#76-operations-monitoring-and-troubleshooting)
  - [7.6.1 Lag, health, and hotspots](#761-lag-health-and-hotspots)
  - [7.6.2 Reassignments and leader balance](#762-reassignments-and-leader-balance)
- [7.7 Multi-Cluster, DR, and MirrorMaker 2](#77-multi-cluster-dr-and-mirrormaker-2)
  - [7.7.1 Topologies and use-cases](#771-topologies-and-use-cases)
  - [7.7.2 MirrorMaker 2 patterns](#772-mirrormaker-2-patterns)
  - [7.7.3 Failover/failback runbooks](#773-failoverfailback-runbooks)
- [7.8 Practical Checklist](#78-practical-checklist)
