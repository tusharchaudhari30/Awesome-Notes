...
- [3.1 Connection and Serialization](#31-connection-and-serialization)
  - [3.1.1 bootstrap.servers](#311-bootstrapservers)
  - [3.1.2 key.serializer](#312-keyserializer)
  - [3.1.3 value.serializer](#313-valueserializer)
- [3.2 Durability and Failure Semantics](#32-durability-and-failure-semantics)
  - [3.2.1 acks (all, 1, 0)](#321-acks-all-1-0)
  - [3.2.2 enable.idempotence](#322-enableidempotence)
  - [3.2.3 retries](#323-retries)
  - [3.2.4 delivery.timeout.ms](#324-deliverytimeoutms)
  - [3.2.5 max.in.flight.requests.per.connection](#325-maxinflightrequestsperconnection)
- [3.3 Throughput Controls](#33-throughput-controls)
  - [3.3.1 batch.size](#331-batchsize)
  - [3.3.2 linger.ms](#332-lingerms)
  - [3.3.3 compression.type (none, gzip, snappy, lz4, zstd)](#333-compressiontype-none-gzip-snappy-lz4-zstd)
- [3.4 Backpressure and Resource Limits](#34-backpressure-and-resource-limits)
  - [3.4.1 buffer.memory](#341-buffermemory)
  - [3.4.2 max.block.ms](#342-maxblockms)
- [3.5 Observability and Control](#35-observability-and-control)
  - [3.5.1 client.id](#351-clientid)
  - [3.5.2 interceptor.classes](#352-interceptorclasses)
- [3.6 Message Semantics and Methods](#36-message-semantics-and-methods)
  - [3.6.1 Send methods choice](#361-send-methods-choice)
- [3.7 Partitioning Behavior](#37-partitioning-behavior)
  - [3.7.1 partitioner.class](#371-partitionerclass)
- [3.8 Headers and Metadata](#38-headers-and-metadata)
  - [3.8.1 Using headers](#381-using-headers)
- [3.9 Quotas and Throttling](#39-quotas-and-throttling)
  - [3.9.1 Broker quotas](#391-broker-quotas)
  - [3.9.2 Client-side throttling](#392-client-side-throttling)
...
1. [Connection and Serialization](#31-connection-and-serialization)
2. [Durability and Failure Semantics](#32-durability-and-failure-semantics)
3. [Throughput Controls](#33-throughput-controls)
4. [Backpressure and Resource Limits](#34-backpressure-and-resource-limits)
5. [Observability and Control](#35-observability-and-control)
6. [Message Semantics and Methods](#36-message-semantics-and-methods)
7. [Partitioning Behavior](#37-partitioning-behavior)
8. [Headers and Metadata](#38-headers-and-metadata)
9. [Quotas and Throttling](#39-quotas-and-throttling)
