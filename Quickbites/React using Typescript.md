...
- [React with TypeScript Setup](#react-with-typescript-setup)
  - [Create React App with TypeScript](#create-react-app-with-typescript)
  - [Project Structure](#project-structure)
  - [tsconfig.json Configuration](#tsconfigjson-configuration)
- [Typing Components](#typing-components)
...
- [Event Handling](#event-handling)
  ...
  - [Type-Safe Event Handlers](#type-safe-event-handlers)
...
- [Advanced Hook Types](#advanced-hook-types)
  - [Custom Hooks](#custom-hooks)
  - [useImperativeHandle](#useimperativehandle)
- [Context API with TypeScript](#context-api-with-typescript)
  - [Basic Context Setup](#basic-context-setup)
  - [Complex Context with Reducer](#complex-context-with-reducer)
- [TypeScript Generics in React](#typescript-generics-in-react)
  - [Generic Components](#generic-components)
  - [Generic Hooks](#generic-hooks)
- [Forms and Validation](#forms-and-validation)
  - [Controlled Form](#controlled-form)
  - [Type-Safe Form Elements](#type-safe-form-elements)
- [TypeScript Utility Types](#typescript-utility-types)
  ...
  - [Practical Example: Form Builder](#practical-example-form-builder)
- [Redux Toolkit with TypeScript](#redux-toolkit-with-typescript)
  - [Store Setup](#store-setup)
  - [Custom Hooks](#custom-hooks-1)
  - [Slice with TypeScript](#slice-with-typescript)
  - [Async Thunks](#async-thunks)
  - [Using Redux in Components](#using-redux-in-components)
- [Performance Optimization](#performance-optimization)
  - [React.memo with TypeScript](#reactmemo-with-typescript)
  - [Lazy Loading](#lazy-loading)
  - [Type-Safe Performance Patterns](#type-safe-performance-patterns)
- [Design Patterns](#design-patterns)
  - [Discriminated Unions](#discriminated-unions)
  - [HOC with TypeScript](#hoc-with-typescript)
...
- [Best Practices](#best-practices)
  ...
  - [2. Avoid `any`](#2-avoid-any)
  - [3. Use Type Inference](#3-use-type-inference)
  - [4. Use `readonly` for Immutability](#4-use-readonly-for-immutability)
  - [5. Prefer Interfaces for Objects](#5-prefer-interfaces-for-objects)
  - [6. Use Type Guards](#6-use-type-guards)
  - [7. Namespace Components](#7-namespace-components)
  - [8. Use Const Assertions](#8-use-const-assertions)
  - [9. Type Your Async Functions](#9-type-your-async-functions)
  - [10. Organize Types](#10-organize-types)
- [Common Interview Questions](#common-interview-questions)
  - [1. Why use TypeScript with React?](#1-why-use-typescript-with-react)
  - [2. Interface vs Type?](#2-interface-vs-type)
  - [3. How to type children props?](#3-how-to-type-children-props)
  - [4. How to type event handlers?](#4-how-to-type-event-handlers)
  - [5. How to create generic components?](#5-how-to-create-generic-components)
  - [6. How to type Redux with TypeScript?](#6-how-to-type-redux-with-typescript)
  - [7. What are utility types?](#7-what-are-utility-types)
  - [8. How to handle optional props?](#8-how-to-handle-optional-props)
- [Resources](#resources)
