...
- [From Basics to Expert](#from-basics-to-expert)
...
- [3. Repository Interfaces](#3-repository-interfaces)
  ...
  - [Built-in Methods (JpaRepository)](#built-in-methods-jparepository)
  - [Service Layer Example](#service-layer-example)
- [4. Query Methods](#4-query-methods)
  - [Supported Keywords](#supported-keywords)
  - [Query Method Examples](#query-method-examples)
...
- [8. Pagination and Sorting](#8-pagination-and-sorting)
  ...
  - [Service Layer with Pagination](#service-layer-with-pagination)
  - [Controller Example](#controller-example)
  - [Custom Query Methods with Pagination](#custom-query-methods-with-pagination)
  - [Page Object Methods](#page-object-methods)
- [9. Specifications and Criteria API](#9-specifications-and-criteria-api)
  - [Enable Specifications](#enable-specifications)
  - [Creating Specifications](#creating-specifications)
  - [Using Specifications](#using-specifications)
  - [Complex Specification Example](#complex-specification-example)
...
- [12. Locking Mechanisms](#12-locking-mechanisms)
  ...
  - [Lock Modes Summary](#lock-modes-summary)
- [13. Auditing](#13-auditing)
  - [Enable JPA Auditing](#enable-jpa-auditing)
  - [Auditable Base Entity](#auditable-base-entity)
  - [Entity Using Auditing](#entity-using-auditing)
  - [AuditorAware Implementation (for CreatedBy/LastModifiedBy)](#auditoraware-implementation-for-createdbylastmodifiedby)
- [14. Caching](#14-caching)
  - [Enable Caching](#enable-caching)
  - [Using Cache Annotations](#using-cache-annotations)
  - [Entity-Level Caching](#entity-level-caching)
- [15. Performance Optimization](#15-performance-optimization)
  - [N+1 Query Problem and Solutions](#n1-query-problem-and-solutions)
    - [Problem Example](#problem-example)
    - [Solution 1: JOIN FETCH](#solution-1-join-fetch)
    - [Solution 2: @EntityGraph](#solution-2-entitygraph)
    - [Solution 3: @NamedEntityGraph](#solution-3-namedentitygraph)
