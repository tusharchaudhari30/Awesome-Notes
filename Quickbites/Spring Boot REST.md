...
- [From Basics to Expert Level](#from-basics-to-expert-level)
- [Table of Contents](#table-of-contents)
- [1. Introduction to REST & Spring Boot {#introduction}](#1-introduction-to-rest-spring-boot-introduction)
  - [What is REST?](#what-is-rest)
  - [Why Spring Boot for REST?](#why-spring-boot-for-rest)
- [2. Core Annotations {#core-annotations}](#2-core-annotations-core-annotations)
  - [@RestController](#restcontroller)
  - [@RequestMapping](#requestmapping)
  - [Specialized Mapping Annotations](#specialized-mapping-annotations)
  - [@PathVariable](#pathvariable)
  - [@RequestParam](#requestparam)
  - [@RequestBody](#requestbody)
  - [@ResponseStatus](#responsestatus)
- [3. Building Basic REST Controllers {#basic-controllers}](#3-building-basic-rest-controllers-basic-controllers)
  - [Complete CRUD Example](#complete-crud-example)
- [4. Request & Response Handling {#request-response}](#4-request-response-handling-request-response)
  - [@RequestHeader](#requestheader)
  - [@CookieValue](#cookievalue)
  - [Request Body with Validation](#request-body-with-validation)
  - [Multiple @RequestParam](#multiple-requestparam)
- [5. Exception Handling {#exception-handling}](#5-exception-handling-exception-handling)
  - [Custom Exception](#custom-exception)
  - [Error Response DTO](#error-response-dto)
  - [Global Exception Handler](#global-exception-handler)
- [6. Validation {#validation}](#6-validation-validation)
  - [Validation Annotations](#validation-annotations)
  - [Custom Validator](#custom-validator)
- [7. HTTP Status Codes & ResponseEntity {#response-entity}](#7-http-status-codes-responseentity-response-entity)
  - [Common HTTP Status Codes](#common-http-status-codes)
  - [ResponseEntity Examples](#responseentity-examples)
- [8. Content Negotiation {#content-negotiation}](#8-content-negotiation-content-negotiation)
  - [XML & JSON Support](#xml-json-support)
- [9. HATEOAS (Hypermedia) {#hateoas}](#9-hateoas-hypermedia-hateoas)
  - [Add Dependency](#add-dependency)
  - [Model Assembler](#model-assembler)
  - [Controller with HATEOAS](#controller-with-hateoas)
- [10. API Documentation (Swagger/OpenAPI) {#swagger}](#10-api-documentation-swaggeropenapi-swagger)
  - [Add Dependency (SpringDoc)](#add-dependency-springdoc)
  - [Configuration](#configuration)
  - [Annotated Controller](#annotated-controller)
  - [application.properties](#applicationproperties)
- [11. Security & JWT Authentication {#security}](#11-security-jwt-authentication-security)
  - [Dependencies](#dependencies)
  - [JWT Utility](#jwt-utility)
  - [JWT Filter](#jwt-filter)
  - [Security Configuration](#security-configuration)
  - [Auth Controller](#auth-controller)
- [12. Testing REST APIs {#testing}](#12-testing-rest-apis-testing)
  - [Dependencies](#dependencies-1)
  - [Unit Test - Controller](#unit-test-controller)
  - [Integration Test](#integration-test)
- [13. Asynchronous REST APIs {#async}](#13-asynchronous-rest-apis-async)
  - [Enable Async Support](#enable-async-support)
  - [Async Service](#async-service)
  - [Async Controller](#async-controller)
- [14. API Versioning {#versioning}](#14-api-versioning-versioning)
  - [URI Path Versioning](#uri-path-versioning)
  - [Request Parameter Versioning](#request-parameter-versioning)
  - [Custom Header Versioning](#custom-header-versioning)
  - [Content Negotiation Versioning](#content-negotiation-versioning)
- [15. REST Clients {#rest-clients}](#15-rest-clients-rest-clients)
  - [RestTemplate (Legacy)](#resttemplate-legacy)
  - [RestClient (Spring Boot 3.2+)](#restclient-spring-boot-32)
  - [WebClient (Reactive)](#webclient-reactive)
- [16. File Upload & Download {#file-operations}](#16-file-upload-download-file-operations)
  - [Configuration](#configuration-1)
  - [File Storage Service](#file-storage-service)
  - [File Controller](#file-controller)
- [17. Pagination & Sorting {#pagination}](#17-pagination-sorting-pagination)
  - [Repository](#repository)
  - [Service](#service)
  - [Controller](#controller)
  - [PagedResponse DTO](#pagedresponse-dto)
- [18. Caching {#caching}](#18-caching-caching)
  - [Enable Caching](#enable-caching)
  - [Service with Caching](#service-with-caching)
  - [Redis Caching](#redis-caching)
- [19. CORS Configuration {#cors}](#19-cors-configuration-cors)
  - [Method-Level CORS](#method-level-cors)
  - [Global CORS Configuration](#global-cors-configuration)
  - [CORS with Security](#cors-with-security)
- [20. Monitoring with Actuator {#actuator}](#20-monitoring-with-actuator-actuator)
  - [Add Dependency](#add-dependency-1)
  - [Configuration](#configuration-2)
  - [Custom Health Indicator](#custom-health-indicator)
  - [Custom Metrics](#custom-metrics)
- [21. Best Practices {#best-practices}](#21-best-practices-best-practices)
  - [1. Use DTOs for API Contracts](#1-use-dtos-for-api-contracts)
  - [2. Proper HTTP Status Codes](#2-proper-http-status-codes)
  - [3. API Response Wrapper](#3-api-response-wrapper)
  - [4. Logging](#4-logging)
  - [5. Rate Limiting](#5-rate-limiting)
  - [6. API Documentation Standards](#6-api-documentation-standards)
- [22. Reactive REST with WebFlux {#webflux}](#22-reactive-rest-with-webflux-webflux)
