...
13. [Auto-Configuration](#13-auto-configuration)
14. [Conditional Annotations](#14-conditional-annotations)
15. [Spring Boot Starters](#15-spring-boot-starters)
16. [Application Properties](#16-application-properties)
17. [Profiles](#17-Profiles)
18. [Externalized Configuration](#18-externalized-configuration)
19. [@SpringBootApplication Annotation](#19-springbootapplication-annotation)
20. [SpringApplication.run() Method](#20-springapplicationrun-method)
21. [Embedded Servers](#21-embedded-servers)
22. [CommandLineRunner and ApplicationRunner](#22-commandlinerunner-and-applicationrunner)
23. [Spring Boot DevTools](#23-spring-boot-devtools)
24. [Lazy Initialization](#24-lazy-initialization)
25. [Spring Boot Actuator](#25-spring-boot-actuator)
26. [Logging in Spring Boot](#26-logging-in-spring-boot)
27. [Exception Handling](#27-exception-handling)
28. [Spring Boot Events](#28-spring-boot-events)
29. [AOP (Aspect-Oriented Programming)](#29-aop-aspect-oriented-programming)
30. [Asynchronous Execution (@Async)](#30-asynchronous-execution-async)
31. [Task Scheduling (@Scheduled)](#31-task-scheduling-scheduled)
32. [Caching](#32-caching)
33. [Testing in Spring Boot](#33-testing-in-spring-boot)
34. [Custom Banner](#34-custom-banner)
35. [Static Resources](#35-static-resources)
