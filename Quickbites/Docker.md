...
- [Docker Architecture](#docker-architecture)
  - [Core Components](#core-components)
    ...
    - [2. Docker Host (Docker Engine)](#2-docker-host-docker-engine)
    - [3. Docker Registry](#3-docker-registry)
  - [Docker Engine Architecture](#docker-engine-architecture)
- [Docker CLI Commands](#docker-cli-commands)
  - [Essential Commands Cheatsheet](#essential-commands-cheatsheet)
...
- [Container Lifecycle Management](#container-lifecycle-management)
  ...
  - [Container Management Best Practices](#container-management-best-practices)
- [Docker Images and Dockerfiles](#docker-images-and-dockerfiles)
  - [Dockerfile Instructions](#dockerfile-instructions)
    - [Essential Instructions](#essential-instructions)
    - [ARG vs ENV Comparison](#arg-vs-env-comparison)
  - [CMD vs ENTRYPOINT](#cmd-vs-entrypoint)
  - [Example Dockerfile](#example-dockerfile)
- [Docker Volumes and Storage](#docker-volumes-and-storage)
  - [Storage Types](#storage-types)
    - [1. Volumes (Recommended)](#1-volumes-recommended)
    - [2. Bind Mounts](#2-bind-mounts)
    - [3. tmpfs Mounts (Linux only)](#3-tmpfs-mounts-linux-only)
  - [Volume vs Bind Mount Comparison](#volume-vs-bind-mount-comparison)
  - [Volume Best Practices](#volume-best-practices)
- [Docker Networking](#docker-networking)
  - [Network Types](#network-types)
    - [1. Bridge Networks (Default)](#1-bridge-networks-default)
    - [2. Host Networks](#2-host-networks)
    - [3. Overlay Networks](#3-overlay-networks)
...
- [Docker Security](#docker-security)
  - [Image Security Best Practices](#image-security-best-practices)
    ...
    - [3. Multi-stage Builds for Security](#3-multi-stage-builds-for-security)
...
- [Docker Swarm](#docker-swarm)
  ...
  - [Swarm Service Example](#swarm-service-example)
- [Registry and Harbor](#registry-and-harbor)
  - [Docker Hub vs Private Registry](#docker-hub-vs-private-registry)
  - [Harbor Private Registry](#harbor-private-registry)
...
- [Best Practices](#best-practices)
  - [Dockerfile Best Practices](#dockerfile-best-practices)
    - [1. Layer Optimization](#1-layer-optimization)
    - [2. .dockerignore Usage](#2-dockerignore-usage)
    - [3. Build Context Optimization](#3-build-context-optimization)
