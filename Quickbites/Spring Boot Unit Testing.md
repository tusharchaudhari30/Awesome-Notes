...
- [3. Testing Annotations Overview](#3-testing-annotations-overview)
  - [Comparison of Test Annotations](#comparison-of-test-annotations)
  - [Annotation Details](#annotation-details)
- [4. Mocking with Mockito](#4-mocking-with-mockito)
  - [@Mock vs @MockBean](#mock-vs-mockbean)
  - [Mockito Stubbing](#mockito-stubbing)
  - [BDD Style with BDDMockito](#bdd-style-with-bddmockito)
  - [Verification](#verification)
  - [ArgumentCaptor](#argumentcaptor)
  - [@Spy and @SpyBean](#spy-and-spybean)
- [5. REST API Testing with MockMvc](#5-rest-api-testing-with-mockmvc)
  - [Basic MockMvc Setup](#basic-mockmvc-setup)
  - [Testing Different HTTP Methods](#testing-different-http-methods)
  - [Testing Request Parameters and Headers](#testing-request-parameters-and-headers)
  - [Testing Validation](#testing-validation)
  - [Testing Exception Handling](#testing-exception-handling)
  - [Advanced MockMvc Features](#advanced-mockmvc-features)
- [6. Database Testing](#6-database-testing)
  - [Testing with @DataJpaTest](#testing-with-datajpatest)
  - [Testing with H2 In-Memory Database](#testing-with-h2-in-memory-database)
  - [Testing with Testcontainers](#testing-with-testcontainers)
  - [Transaction Management in Tests](#transaction-management-in-tests)
  - [Testing with @JdbcTest](#testing-with-jdbctest)
- [7. Spring Boot Test Slices](#7-spring-boot-test-slices)
  - [@WebMvcTest - Web Layer Testing](#webmvctest-web-layer-testing)
  - [@JsonTest - JSON Serialization Testing](#jsontest-json-serialization-testing)
  - [@RestClientTest - REST Client Testing](#restclienttest-rest-client-testing)
- [8. Advanced Testing Techniques](#8-advanced-testing-techniques)
  ...
  - [ReflectionTestUtils - Testing Private Fields](#reflectiontestutils-testing-private-fields)
- [9. Best Practices](#9-best-practices)
  - [1. Follow AAA Pattern (Arrange-Act-Assert)](#1-follow-aaa-pattern-arrange-act-assert)
  - [2. Use Descriptive Test Names](#2-use-descriptive-test-names)
  - [3. One Assertion Per Test Concept](#3-one-assertion-per-test-concept)
  - [4. Use Test Slices for Faster Tests](#4-use-test-slices-for-faster-tests)
  - [5. Avoid Testing Framework Code](#5-avoid-testing-framework-code)
  - [6. Mock External Dependencies](#6-mock-external-dependencies)
  - [7. Keep Tests Independent](#7-keep-tests-independent)
- [10. Common Pitfalls](#10-common-pitfalls)
  - [1. Not Using @Transactional Correctly](#1-not-using-transactional-correctly)
  - [2. Overusing @SpringBootTest](#2-overusing-springboottest)
  - [3. Not Verifying Mock Interactions](#3-not-verifying-mock-interactions)
  - [4. Testing Implementation Instead of Behavior](#4-testing-implementation-instead-of-behavior)
  - [5. Ignoring Test Data Setup](#5-ignoring-test-data-setup)
- [Complete Example: Testing a Full Service Layer](#complete-example-testing-a-full-service-layer)
- [Summary](#summary)
