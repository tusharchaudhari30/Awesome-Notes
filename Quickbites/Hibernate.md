...
- [3. Setting Up Hibernate with Spring Boot](#3-setting-up-hibernate-with-spring-boot)
  - [Maven Dependencies (pom.xml)](#maven-dependencies-pomxml)
...
- [4. Entity Mapping and Annotations](#4-entity-mapping-and-annotations)
  - [Basic Entity Example](#basic-entity-example)
  - [Key Annotations Explained](#key-annotations-explained)
    - [@Entity](#entity)
    - [@Table](#table)
    - [@Id and Primary Key Generation Strategies](#id-and-primary-key-generation-strategies)
    - [@Column](#column)
  - [Validation Annotations](#validation-annotations)
- [5. Hibernate Entity Lifecycle](#5-hibernate-entity-lifecycle)
  - [1. Transient State](#1-transient-state)
  - [2. Persistent State](#2-persistent-state)
  - [3. Detached State](#3-detached-state)
  - [4. Removed State](#4-removed-state)
...
- [6. Relationships and Associations](#6-relationships-and-associations)
  ...
  - [@OneToMany and @ManyToOne Relationship](#onetomany-and-manytoone-relationship)
...
- [9. Hibernate Session and SessionFactory](#9-hibernate-session-and-sessionfactory)
  - [SessionFactory Configuration (Traditional Hibernate)](#sessionfactory-configuration-traditional-hibernate)
  - [Using Session](#using-session)
  - [getCurrentSession() vs openSession()](#getcurrentsession-vs-opensession)
- [10. Transaction Management](#10-transaction-management)
  - [Declarative Transaction Management with @Transactional](#declarative-transaction-management-with-transactional)
  - [Programmatic Transaction Management](#programmatic-transaction-management)
- [11. Caching in Hibernate](#11-caching-in-hibernate)
  - [First-Level Cache (Session Cache)](#first-level-cache-session-cache)
  - [Second-Level Cache (SessionFactory Cache)](#second-level-cache-sessionfactory-cache)
  - [Cache Operations](#cache-operations)
- [12. Fetching Strategies](#12-fetching-strategies)
  - [Lazy vs Eager Loading](#lazy-vs-eager-loading)
  - [JOIN FETCH to Avoid LazyInitializationException](#join-fetch-to-avoid-lazyinitializationexception)
  - [@EntityGraph](#entitygraph)
  - [Batch Fetching](#batch-fetching)
- [13. N+1 Problem and Solutions](#13-n1-problem-and-solutions)
  - [Understanding N+1 Problem](#understanding-n1-problem)
  - [Solution 1: JOIN FETCH](#solution-1-join-fetch)
  - [Solution 2: @EntityGraph](#solution-2-entitygraph)
  - [Solution 3: Batch Fetching](#solution-3-batch-fetching)
  - [Solution 4: @Fetch(FetchMode.SUBSELECT)](#solution-4-fetchfetchmodesubselect)
  - [Enable SQL Logging to Detect N+1](#enable-sql-logging-to-detect-n1)
- [14. Batch Processing](#14-batch-processing)
  - [Configuration](#configuration)
  - [Batch Insert Example](#batch-insert-example)
  - [Batch Update Example](#batch-update-example)
  - [Using StatelessSession for Large Batches](#using-statelesssession-for-large-batches)
- [15. Pagination](#15-pagination)
  - [Using setFirstResult() and setMaxResults()](#using-setfirstresult-and-setmaxresults)
  - [Spring Data JPA Pageable](#spring-data-jpa-pageable)
  - [Custom Pagination Response](#custom-pagination-response)
- [16. Inheritance Strategies](#16-inheritance-strategies)
  ...
  - [TABLE_PER_CLASS Strategy](#table_per_class-strategy)
- [17. Composite Primary Keys](#17-composite-primary-keys)
  - [Using @IdClass](#using-idclass)
  - [Using @EmbeddedId](#using-embeddedid)
- [18. Locking Mechanisms](#18-locking-mechanisms)
  - [Optimistic Locking](#optimistic-locking)
  - [Pessimistic Locking](#pessimistic-locking)
  - [Lock Modes Comparison](#lock-modes-comparison)
- [19. Auditing](#19-auditing)
  - [Basic Auditing with JPA](#basic-auditing-with-jpa)
  - [Auditor Provider](#auditor-provider)
  - [Hibernate Envers (Advanced Auditing)](#hibernate-envers-advanced-auditing)
...
- [21. Best Practices](#21-best-practices)
  - [1. Entity Design Best Practices](#1-entity-design-best-practices)
  - [2. Transaction Management Best Practices](#2-transaction-management-best-practices)
  - [3. Fetching Best Practices](#3-fetching-best-practices)
  - [4. Query Best Practices](#4-query-best-practices)
  - [5. Session Management](#5-session-management)
  - [6. Common Pitfalls to Avoid](#6-common-pitfalls-to-avoid)
  - [7. Performance Tips Summary](#7-performance-tips-summary)
